var slider = {
  init: function(slideshow, slideText, slide, prevBtn, nextBtn, pauseBtn, imgText, imgs, time, i){
  ...
  nextImg: function(){
    ...
    $(slider.slide)[0].src = slider.imgs[slider.i]; 
	$(slider.slideText)[0].innerHTML = slider.imgText[slider.i];
  },
  ...
  playPause: function() {
    if(slider.auto) {
      ...
      slider.auto = null;
      $(slider.pauseBtn)[0].className = "playBtn";
    }else{
      slider.auto = setInterval(slider.nextImg, slider.time);
      $(slider.pauseBtn)[0].className = "pauseBtn";
    };
  },
